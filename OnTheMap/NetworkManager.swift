...
class NetworkManager: NSObject {
    ...
    func taskForGETMethod(method: String, parameters: [String : AnyObject], completionHandler: (result: AnyObject!, error: NSError?) -> Void) -> NSURLSessionDataTask {
        ...
        let urlString = Constants.UdacityURLSecure + method + NetworkManager.escapedParameters(mutableParameters)
        ...
        let task = session.dataTaskWithRequest(request) { (data, response, error) in
            ...
            NetworkManager.parseJSONWithCompletionHandler(newData, completionHandler: completionHandler)
        }
    ...
    func taskForParseGETMethod(method: String, parameters: [String : AnyObject], completionHandler: (result: AnyObject!, error: NSError?) -> Void) -> NSURLSessionDataTask {
        ...
        /* 1. Set the parameters */
        /* 2/3. Build the URL and configure the request */
        let urlString = Constants.parseURL + method + NetworkManager.escapedParameters(parameters)
        let url = NSURL(string: urlString)!
        let request = NSMutableURLRequest(URL: url)
